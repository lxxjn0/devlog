...
date: 2020-10-11
description: learn about java string
tags:
  - Woowacourse
  - Spring
  - String
slug: "/dive-into-string"
---

> 이 글은 [우아한테크코스 리뷰 페이지](https://woowacourse.github.io/javable/2020-09-07/dive-into-java-string)에 함께 게시된 글입니다.
...
> 참고로 String Constant Pool의 위치는 Java 7부터 **Heap 영역**으로 옮겨졌다.
>
...
>
> Heap 영역은 **GC의 대상**이기 때문에 String Constant Pool에서 참조를 잃은 문자열 객체들은 다시 메모리로 반환된다.
