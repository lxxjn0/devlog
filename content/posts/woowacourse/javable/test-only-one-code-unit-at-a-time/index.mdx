...
date: 2020-04-25
description: Test only one code unit at a time
tags:
  - Woowacourse
  - Java
  - Test
slug: "/test-only-one-code-unit-at-a-time"
---

> 이 글은 [우아한테크코스 리뷰 페이지](https://woowacourse.github.io/javable/2020-04-24/one-test-must-check-one-scenario)에 함께 게시된 글입니다.
...
`isGreaterThanFive()`라는 메서드를 테스트 할 수 있는 방법은 2가지가 있다.
...
![feedback image 01](./test-only-one-code-unit-at-a-time-image-01.png)
