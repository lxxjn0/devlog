...
> 이 글은 [우아한테크코스 리뷰 페이지](https://woowacourse.github.io/javable/2020-07-29/dont-use-else)에 함께 게시된 글입니다.
...
![precourse don't use else](./dont-use-else.png)
