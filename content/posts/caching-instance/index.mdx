...
date: 2020-06-24
description: Caching instance
tags:
  - Java
  - Cache
  - Woowacourse
slug: "/caching-instance"
---

> 이 글은 [우아한테크코스 리뷰 페이지](https://woowacourse.github.io/javable/2020-06-24/caching-instance)에 함께 게시된 글입니다.
...
![java wrapper class](./wrapper-class.png)
...
![Lotto caching feedback](./caching-feedback.png)
...
로또 번호에 해당하는 LottoNumber 인스턴스가 유효성 검증을 제외한 다른 로직이 없으면 1~45 사이의 LottoNumber는 값만 같으면 같은 역할을 하는 인스턴스(VO, Value Object)가 된다. 그럴 경우 600,000개의 서로 다른 LottoNumber 인스턴스 생성은 상당한 메모리 낭비이다.
